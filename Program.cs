...
namespace TrayTemperature
{
    ...
    {
        static System.Threading.Mutex mutex = new System.Threading.Mutex(true, Application.ProductName);
        ...
        static void Main()
        {
            ...
            //Inititalize LibreHardwareMonitor
            computer.Open();
            ...
            contextMenu.MenuItems.AddRange(new MenuItem[] {
                new MenuItem {
                    Text = "TrayTemperature, recore67's fork",
                    Enabled = false
                },
                new MenuItem {
